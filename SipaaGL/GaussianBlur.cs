...
namespace SipaaGL
{
    public unsafe class GaussianBlur
    {
        ...
        public GaussianBlur(Image image)
        {
            var rct = new Rectangle(0, 0, (int)image.Width, (uint)image.Height);
        ...
        public Image Process(int radial)
        {
            ...
            var image = new Image((uint)_width, (uint)_height);
            var rct = new Rectangle(0, 0, (int)image.Width, (int)image.Height);
            MemoryOperations.Copy((byte*)image.Internal, (byte*)dest, dest.Length)
